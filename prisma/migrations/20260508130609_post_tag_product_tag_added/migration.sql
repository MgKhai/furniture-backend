/*
  ...
  - You are about to drop the `Taggle` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "Taggle" DROP CONSTRAINT "Taggle_tagId_fkey";
